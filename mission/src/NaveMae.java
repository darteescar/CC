        ...
        while(true){
            ...
            new Thread(() -> {
                if (msg.getTipo() == TipoMensagem.ML_SYN && msg != null){
                    System.out.println("[NaveMae] SYN recebido do rover " + msg.getIdOrg() + " via MissionLink.");
                    ...
                    System.out.println("[NaveMae] ACK recebido do rover " + msg.getIdOrg() + " via MissionLink.");
                }else if (msg.getTipo() == TipoMensagem.ML_REQUEST && msg != null){
                    System.out.println("[NaveMae] Request de missão recebido do rover " + msg.getIdOrg() + " via MissionLink.");
                    processRequestML(msg);
                } else if (msg.getTipo() == TipoMensagem.ML_CONFIRM && msg != null){
                    System.out.println("[NaveMae] Confirmação de receção de missão recebido do rover " + msg.getIdOrg() + " via MissionLink.");
                } else {
